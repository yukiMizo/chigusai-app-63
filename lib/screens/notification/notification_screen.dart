...
class NotificationDataToPass {
  ...
  NotificationDataToPass({required this.data, required this.index});
}
...
class _NotificationScreenState extends ConsumerState<NotificationScreen> {
  ...
  Future _loadData() async {
    ...
    for (var data in gotData.docs) {
      ...
      _notifications.add({"id": id, "timeStamp": d["timeStamp"].toDate(), "content": d["content"], "title": d["title"]});
    }
  ...
  Widget _notificationWidget({required notificationData, required int index, bool? isLoggedInAdmin}) {
    return SizedBox(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text(DateFormat('yyyy/MM/dd HH:mm').format(notificationData["timeStamp"]), style: const TextStyle(color: Colors.grey, fontSize: 14)),
                    ],
                  ),
                        ...
                        child: Scrollbar(
                          child: SingleChildScrollView(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(notificationData["title"], style: const TextStyle(fontWeight: FontWeight.w600)),
              ...
              SizedBox(
                ...
                child: FilledButton(
                  ...
                  onPressed: () async {
                    ...
                    if (!mounted) return;
                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('通知を消去しました。')));
