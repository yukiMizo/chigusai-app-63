          ...
          child: Column(
            children: [
              ...
              const SizedBox(
                ...
                child: Text('イベント', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              ),
              const SizedBox(height: 20),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  _eventButton(lable: "体育祭", onPressed: () => ref.read(bottomNavigationProvider.notifier).set(1)),
                  const SizedBox(width: 20),
                  _eventButton(lable: "文化祭", onPressed: () => ref.read(bottomNavigationProvider.notifier).set(2)),
                  const SizedBox(width: 20),
                  _eventButton(lable: "全校企画", onPressed: () => ref.read(bottomNavigationProvider.notifier).set(3)),
                ],
              ),
              ...
              Column(
                children: [
                  _functionButton(text: "マップ", icon: Icons.map, onPressed: () => Navigator.of(context).pushNamed(MapScreen.routeName)),
