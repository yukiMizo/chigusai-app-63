...
class ZenkouPage extends StatelessWidget {
  ...
  Widget _buildZenkouCard(BuildContext context, ZenkouDetailData zenkouDetailData) {
    return Card(
      child: ListTile(onTap: () {}, leading: Text(zenkouDetailData.startTime.getTimeAsString()), title: Text(zenkouDetailData.title)),
    );
  }
    ...
    return const SizedBox(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [Text('全校企画', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold))],
        ),
      ),
    );
  }
