...
class TaiikusaiPage extends StatelessWidget {
  ...
  Widget _buildTaiikusaiCard(BuildContext context, TaiikusaiDetailData taiikusaiDetailData) {
    return Card(
      child: ListTile(onTap: () {}, leading: Text(taiikusaiDetailData.startTime.getTimeAsString()), title: Text(taiikusaiDetailData.title)),
    );
  }
    ...
    return const SizedBox(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [Text('体育祭', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold))],
        ),
      ),
    );
  }
