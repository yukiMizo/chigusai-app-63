...
class RankWidgetData {
  ...
  const RankWidgetData({required this.place, required this.className, required this.point});
}
...
class AwardBlockData {
  ...
  const AwardBlockData({required this.title, required this.rankWidgetDataList});
}
              ...
              child: SingleChildScrollView(
                child: Padding(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Padding(padding: const EdgeInsets.only(top: 20), child: _buildAwardBlock(taiikusaiDataList[index].title));
                    },
                  ),
                ),
              ),
