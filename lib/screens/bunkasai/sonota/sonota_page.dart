...
import '../../../data/bunkasai/sonota_data.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              GridView.builder(
                primary: false,
                shrinkWrap: true,
                gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(crossAxisSpacing: 5, mainAxisSpacing: 10, crossAxisCount: 2),
