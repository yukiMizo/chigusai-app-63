...
class BunkasaiScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const List<Tab> tabs = [Tab(text: "展示"), Tab(text: "演劇"), Tab(text: "有志"), Tab(text: "部活"), Tab(text: "その他")];
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          bottom: const TabBar(indicatorSize: TabBarIndicatorSize.tab, unselectedLabelColor: AppColors.lightText1, labelColor: AppColors.lightText1, tabs: tabs, isScrollable: true),
        ),
        drawer: const MainDrawer(),
        body: const TabBarView(children: [TenjiPage(), EngekiPage(), YushiPage(), BukatsuPage(), SonotaPage()]),
      ),
    );
  }
}
