    ...
    return Card(
      child: Padding(
        ...
        child: ListTile(
          ...
          title: Text("${engekiDetailData.hr}「${engekiDetailData.title}」", style: const TextStyle(fontWeight: FontWeight.w500)),
  ...
  Widget _buildHeader() {
    return const SizedBox(
      ...
      child: Padding(
        ...
        child: Text('演劇', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold)),
      ),
    );
  }
