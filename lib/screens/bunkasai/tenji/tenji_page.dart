  ...
  Widget _buildHeader() {
    return const SizedBox(
      ...
      child: Padding(
        ...
        child: Text('展示', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold)),
      ),
    );
  }
                  ...
                  Row(
                    ...
                    children: [
                      IconButton(
                        ...
                        icon: Icon(Icons.arrow_left, size: 80, color: Colors.grey.shade800),
                      ),
                      IconButton(
                        onPressed: () {
                          setStateInDialog(() {
                        ...
                        padding: EdgeInsets.zero,
                        constraints: const BoxConstraints(),
                        icon: Icon(Icons.arrow_right, size: 80, color: Colors.grey.shade800),
                      ),
                    ],
                  ),
                ],
                    ...
                    child: FilledButton(
                      onPressed: currentKomiLevel == newKomiLevel
                          ...
                          : () async {
                              ...
                              final int komiNum = switch (newKomiLevel) {
                                KomiLevel.komi1 => 1,
                                KomiLevel.komi2 => 2,
                                KomiLevel.komi3 => 3,
                              };
