...
class YushiPage extends StatelessWidget {
  ...
  final List<Tab> _tabs = const [Tab(text: '1日目', height: 30), Tab(text: '2日目', height: 30)];
    ...
    return Card(
      child: Padding(
        ...
        child: ListTile(
          ...
          leading: Text(yushiDetailData.startTime.getTimeAsString(), style: const TextStyle(fontSize: 20)),
          title: Text(yushiDetailData.title, style: const TextStyle(fontSize: 20)),
      ...
      delegate: SliverChildListDelegate([
        const SizedBox(
          ...
          child: Padding(
            ...
            child: Text('有志', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold)),
          ),
        ),
      ]),
    );
