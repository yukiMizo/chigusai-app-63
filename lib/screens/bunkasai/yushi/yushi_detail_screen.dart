          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(yushiDetailData.title, style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
                const SizedBox(height: 5),
                Text("日時：${yushiDetailData.startTime.getDayAsString()}  ${yushiDetailData.startTime.getTimeAsString()}〜", style: const TextStyle(fontSize: 18)),
                Text("場所：${yushiDetailData.place}", style: const TextStyle(fontSize: 18)),
