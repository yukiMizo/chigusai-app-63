  ...
  Widget _buildBukatsuCard(BuildContext context, BukatsuDetailData bukatsuDetailData) {
    return Card(
      child: ListTile(
        ...
        title: Text(bukatsuDetailData.club, style: const TextStyle(fontWeight: FontWeight.w500)),
  ...
  Widget _buildHeader() {
    return const SizedBox(
      ...
      child: Padding(
        ...
        child: Text('部活', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold)),
      ),
    );
  }
