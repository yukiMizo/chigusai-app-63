...
import '../../../data/zenkokikaku/zenkou_data.dart';
  ...
  Widget _buildZenkouCard(BuildContext context, ZenkouDetailData zenkouDetailData, void Function()? onPressed) {
    return Card(
      child: Padding(
        ...
        child: ListTile(
          onTap: onPressed,
          leading: Text(zenkouDetailData.startTime.getTimeAsString(), style: const TextStyle(fontSize: 20)),
          title: Text(zenkouDetailData.title, style: const TextStyle(fontSize: 20)),
  ...
  Widget _buildHeader() {
    return const SizedBox(
      ...
      child: Padding(
        ...
        child: Text('全校企画', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold)),
      ),
    );
  }
              ...
              children: [
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return _buildZenkouCard(context, zenkouDataList[index], _onPressed(context, zenkouDataList[index].zenkouEventType));
                  },
                ),
