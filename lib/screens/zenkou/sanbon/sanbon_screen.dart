...
import '../../../data/zenkokikaku/sanbon_data.dart';
        ...
        child: ListTile(
          ...
          leading: Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(fit: BoxFit.cover, image: AssetImage(sanbonDetailData.imgPath)),
            ),
          ),
          title: Text(sanbonDetailData.title, style: const TextStyle(fontWeight: FontWeight.w500)),
        ),
      ),
    );
  }
