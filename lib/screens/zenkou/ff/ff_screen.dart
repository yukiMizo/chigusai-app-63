...
import '../../../data/zenkokikaku/ff_data.dart';
  ...
  Widget _buildFFCard(BuildContext context, FFDetailData ffDetailData) {
    ...
    return Card(
      child: Padding(
        ...
        child: ListTile(
          onTap: onTap,
          leading: Text(ffDetailData.startTime.getTimeAsString(), style: const TextStyle(fontSize: 20)),
          title: Text(ffDetailData.title, style: const TextStyle(fontSize: 20)),
          ...
          child: Stack(
            ...
            children: [
              Column(
                ...
                children: [Expanded(child: InteractiveViewer(minScale: 0.1, maxScale: 5, child: Image.asset(imgPath)))],
              ),
              Row(
                children: [
                  Material(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(
                  ...
                  child: Text("スケジュール（予定）", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500)),
                ),
                Padding(
                  padding: const EdgeInsets.all(10),
                  child: GestureDetector(
                    onTap: () => _showImage(context, "assets/images/yotei.png"),
                    child: Container(
                      margin: const EdgeInsets.symmetric(horizontal: 15),
                      decoration: const BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(3))),
                      clipBehavior: Clip.antiAlias,
                      child: Image.asset("assets/images/yotei.png"),
                    ),
                  ),
                ),
                const SizedBox(height: 100),
