    ...
    return const SizedBox(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [Text('9/6 体育祭', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold))],
        ),
      ),
    );
  }
              ...
              children: [
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return TaiikusaiShiftCard(taiikusaiDataList: _taiikusaiDataList, day: _day, index: index, loadedTimeMap: _loadedTimeMap);
                  },
                ),
              ],
            ),
